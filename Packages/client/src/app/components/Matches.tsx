...
export function Matches() {
  ...
  const [newMatchCelebration, setNewMatchCelebration] = useState<User | null>(
    null,
  ); // For success popup
  ...
  const handleChatOpen = (match: Match) => {
    ...
    setMatches(
      matches.map((m) => (m.id === match.id ? { ...m, unreadCount: 0 } : m)),
    );
  };
                  ...
                  <div className="flex flex-col gap-2 items-end flex-shrink-0">
                    ...
                    <div className="relative">
                      <button
                        onClick={() =>
                          setMenuOpenId(
                            menuOpenId === match.id ? null : match.id,
                          )
                        }
        ...
        {newMatchCelebration && (
          <div className="fixed inset-0 z-[70] flex items-center justify-center pointer-events-none">
            <motion.div
              ...
              onAnimationComplete={() =>
                setTimeout(() => setNewMatchCelebration(null), 2500)
              }
            ...
            >
              <motion.div
                ...
                className="inline-block bg-pink-100 p-4 rounded-full mb-4"
              >
                    ...
                    */}
                    <div className="p-4 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl">
                      ...
                      <p className="text-gray-800">
                        {getAge(detailsMatch.user.name)} years
                      </p>
                    </div>
    ...
    <div className="relative w-[340px] h-[580px]">
      ...
      <motion.div
        ...
        animate={{
          ...
          x:
            dragDirection === "right" ? 50 : dragDirection === "left" ? -50 : 0,
        }}
      ...
      >
        ...
        <div className="relative h-[70%]">
          ...
          {dragDirection && (
            <div
              className={`absolute top-8 ${dragDirection === "right" ? "left-8" : "right-8"} border-4 font-bold text-2xl px-4 py-2 rounded-lg transform -rotate-12 ${dragDirection === "right" ? "border-green-500 text-green-500" : "border-red-500 text-red-500"}`}
            >
        ...
        <div className="h-[30%] flex flex-col justify-between p-6 bg-white">
          ...
          <div className="flex justify-center gap-8">
            ...
            <motion.button
              ...
              className="w-14 h-14 rounded-full bg-green-100 text-green-500 flex items-center justify-center hover:bg-green-200 transition-colors"
            >
